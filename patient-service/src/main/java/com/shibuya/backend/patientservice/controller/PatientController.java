package com.shibuya.backend.patientservice.controller;
...
import com.shibuya.backend.patientservice.dto.validators.CreatePatientValidationGroup;
import com.shibuya.backend.patientservice.service.PatientService;
...
public class PatientController {
    ...
    public ResponseEntity<Void> deletedPatient(@PathVariable UUID id){
